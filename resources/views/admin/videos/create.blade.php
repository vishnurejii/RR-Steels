...
<div class="mb-12">
    ...
    <h1 class="text-4xl font-black uppercase italic tracking-tighter mt-4">Add New <span class="text-gray-400">Video</span></h1>
</div>
    ...
    <form action="{{ route('admin.videos.store') }}" method="POST">
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <input type="url" name="video_url" value="{{ old('video_url') }}" required placeholder="https://youtu.be/..."
                    class="w-full bg-gray-50 border-2 border-gray-100 rounded-xl px-4 py-3 focus:border-gray-900 outline-none transition-all">
